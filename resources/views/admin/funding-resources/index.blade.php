...
@section('content')
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{ route('funding_resources.create') }}" class="btn btn-primary text-uppercase font-weight-bold">Registrar
                nuevo</a>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    "render": function(data, type, row, meta) {
                        return (
                            `<div class="d-flex flex-row justify-content-end">
                                <a class="btn btn-primary btn-sm mr-2 font-weight-bold btn-edit" href="{{ route('funding_resources.edit', ':id') }}"><i class="far fa-edit"></i> EDITAR</a>
            ...
            let table = $(`#table`).DataTable({
                "ajax": {
                    "url": "{{ route('funding_resources.data') }}",
                    "type": "GET",
                    "dataSrc": "",
                },
            ...
            $(`#table tbody`).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('funding_resources.destroy') }}",
                            type: "POST",
                            dataType: 'json',
                            data: {
                                "_token": "{{ csrf_token() }}",
