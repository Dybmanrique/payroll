                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model='code' id="code" class="form-control"
                                placeholder="Ingrese el código" required autocomplete="off">
                            @error('code')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" wire:model='description' id="description" rows="5" placeholder="Ingrese una descripción"></textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
