<x-guest-layout>
    ...
    <form method="POST" action="{{ route('empleado.login') }}">
        ...
        <div>
            ...
            <x-text-input id="identity_number" class="block mt-1 w-full" type="text" name="identity_number" :value="old('identity_number')" required autofocus autocomplete="identity_number" />
